...
/**
 * Según la tarea actual setea el atributo que indica en qué tarea se encuentra el proceso actualmente.
 * Luego de ello, notifica al usuario correspondiente (enviando un mail) que tiene la tarea para completar.
 */
