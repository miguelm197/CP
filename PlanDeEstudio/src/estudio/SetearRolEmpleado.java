...
public class SetearRolEmpleado extends ApiaAbstractClass {
	...
	protected void executeClass() throws BusClassException {
		...
		String nombreJefe = this.getUser(jefe).getName();
		...
		Helpers.notificarInicioProcesoEst(this, nombreCreador, mail, titulo, tema, nombreJefe, fechaInicio, fechaFin, comentarios);
